...
<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="<?php echo base_url(); ?>" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <img src="<?php echo base_url(); ?>assets/img/logo1.png" alt="" class="img-fluid logo-img" style="width: 300px; height:auto;">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?php echo base_url(); ?>index.php/Store">Store</a></li>
      ...
      <div class="d-flex align-items-center mr-5">
        ...
        <?php endif; ?> -->
        <div>
            <a class="btn" style="background-color: #e84545; color: white;" href="<?php echo base_url(); ?>index.php/camp">BneiCamp</a>
          </div>
      </div>
